        ...
        <div class="bg-gray-200 flex justify-center py-10">
            <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm">
                ...
                @else
                    ...
                    @if ($totalMCQs > 0)
                        <p class="text-indigo-600 font-bold text-center"><a
                                href="show-quiz/{{ session('quizDetails')->id }}">Show All MCQ's</a></p>
                    @endif
                    ...
                    <form action="/add-mcq" method="post" class="space-y-4">
                        ...
                        <button type="submit" value="done" name="submit"
                            ...
                            Submit</button>
                        <a href="/end-quiz"
                            class="w-full block text-center bg-red-500 hover:bg-red-800 rounded-xl px-4 py-2 text-white">Finish
                            Quiz</a>
                    </form>
                @endif
            </div>
